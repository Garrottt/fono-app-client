      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-600 hover:bg-white transition-colors"
          >
            Hoy
          </button>
          <button
        ...
        <div className="grid grid-cols-[minmax(0,2fr)_minmax(320px,1fr)] gap-6">
          <section className="bg-white rounded-xl shadow-sm p-5">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-lg font-medium text-gray-800 capitalize">{monthLabel}</h3>
                <p className="text-xs text-gray-400 mt-1">Arrastra una cita a otro día para reagendarla.</p>
              </div>
                    ...
                    <div className="space-y-1">
                      {dayAppointments.slice(0, 3).map((appointment) => (
                        <div
                          ...
                          className={`rounded-md border px-2 py-1 text-[11px] shadow-sm cursor-grab active:cursor-grabbing ${getStatusStyle(appointment.status)}`}
                        >
          ...
          <section className="flex flex-col gap-6">
            <div className="bg-white rounded-xl shadow-sm p-5">
              <h3 className="text-lg font-medium text-gray-800 mb-1">Detalle del día</h3>
              ...
              {selectedAppointments.length === 0 ? (
                <p className="text-sm text-gray-400">No hay citas agendadas para este día.</p>
              ) : (
            ...
            <div className="bg-white rounded-xl shadow-sm p-5">
              <h3 className="text-lg font-medium text-gray-800 mb-1">Agendar desde inicio</h3>
              <p className="text-sm text-gray-500 mb-4">
                Crea una cita rápida para organizar el día sin salir del calendario.
              </p>
